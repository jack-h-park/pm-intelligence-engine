# AGENTS.md — jackhpark-pm-intelligence-engine *(→ pm-intelligence-engine)*
...
│   ├── run_exporter.py    Writes completed runs to DECISION_CONTEXT_ROOT/DECISION_SYSTEM_ROOT products/.../runs/
